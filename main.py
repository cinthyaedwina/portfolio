...
from streamlit_option_menu import option_menu  # Perbaiki import
...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Get to know Cindy", "Dashboard Visualization"],  # Tambahkan daftar menu
        default_index=0
    )

if selected == "Get to know Cindy":
    st.title("Welcome to my porfolio's page")
    # Load an image
    image = "images/Capture.jpg"
    st.image(image, caption="cindy", width=100)
    st.write("Hello, I'm Cindy. Currently exploring about anything related to data.")
    

if selected == "Dashboard Visualization":
